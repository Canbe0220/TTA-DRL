...
def main():
    ...
    model_paras["actor_in_dim"] = model_paras["out_size_ma"] + model_paras["out_size_ope"] + model_paras["out_size_pair"]
    ...
    memories = ACP.Memory()
    model = ACP.ACP(model_paras, train_paras, num_envs=env_paras["batch_size"])
